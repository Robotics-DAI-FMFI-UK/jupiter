...
r"""Exam
ple using PyCoral to classify a given image using an Edge TPU.
...
def classification():
  ...
  parser.add_argument(
      '-m', '--model', default='clothes/clothes_model_edgetpu.tflite', help='File path of .tflite file.')
  parser.add_argument(
      '-i', '--input', default='clothes/received.png', help='Image to be classified.')
  parser.add_argument(
      '-l', '--labels', default='clothes/clothing_labels.txt', help='File path of labels file.')
