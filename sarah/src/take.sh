...
sleep 1
rostopic pub -1 /elbow_controller/command std_msgs/Float64 -- 1.9 &
sleep 0.5
...
sleep 1
rostopic pub -1 /hand_controller/command std_msgs/Float64 -- 0.12 &
sleep 1
killall rostopic
rostopic pub -1 /shoulder_controller/command std_msgs/Float64 -- -0.2 &
